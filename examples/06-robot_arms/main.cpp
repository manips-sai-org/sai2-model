...
int main(int argc, char** argv) {
	const string puma_fname =
		string(SAI2_MODEL_URDF_FOLDER) + "/puma/puma.urdf";
	...
	cout << "puma joint angles coordinates : " << puma_robot.q().transpose() << endl;
	cout << "puma jacobian at the end effector : \n" << puma_robot.J("end-effector") << endl;

	cout << endl << endl;
	cout << "kuka degrees of freedom : " << kuka_robot.dof() << endl;
	cout << "kuka joint angles coordinates : " << kuka_robot.q().transpose() << endl;
